...
<li <?php wc_product_class('', $product); ?>>
    <div class="card">
        <?php
        $thumbnail = has_post_thumbnail($loop->post->ID) ? get_the_post_thumbnail($loop->post->ID, array(200, 200)) : '<img src="' . wc_placeholder_img_src() . '" alt="Placeholder" loading="lazy">';
        echo $thumbnail;
        ?>
        <div class="content">
            <a href="<?php echo esc_url(get_permalink($loop->post->ID)); ?>" class="permalink">
