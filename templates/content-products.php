<?php
    ...
    echo '
    <li'; wc_product_class( '', $product ); echo '>
        <div class="card">';
            ...
            echo '  
            <div class="content">
                <a href="' . esc_url( get_permalink( $loop->post->ID ) ) . '" class="permalink"><h3 class="title">'; the_title(); echo '</h3></a>';
                if ( $average_rating > 0 ) :
                echo '<div class="rating">';
                    echo wc_get_rating_html( $average_rating );
                    echo '<span class="votes-rating">' . $rating_count . ' votos' . '</span>
                </div>';
                else :
                    echo '
                    <div class="rating">
                        ...
                        <span class="votes-rating">0 votos</span>
                </div>';
                endif; 
