...
echo '<ul class="attachment-list">';
    ...
    echo '<li>
        <a class="counter cart-customlocation" href="'; echo esc_url(wc_get_cart_url()); echo '" title="'; _e( 'View your shopping cart' ); echo '">
            ...
            <div class="wrapper"><span class="number">'; echo sprintf ( _n( '%d item', '%d items', WC()->cart->get_cart_contents_count() ), WC()->cart->get_cart_contents_count() ); echo WC()->cart->get_cart_total();  echo'</span></div>
        </a>
    </li>';
echo '</ul>';