<section id="arrivals" class="container main-content">
    <div class="title-wrapper section">
        ...
        <div class="slideshow-buttons__arrivals">
            <button id="backward-button__arrivals" class="arrivals--button">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-left" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0z"/>
                </svg>
            </button>
            <button id="forward-button__arrivals" class="arrivals--button">
      ...
      <div class="section"> 
        <div class="arrivals-wrapper">
            <ul id="arrivals-list" class="arrivals-list product-list">       
                <?php
                    $args = array(
                        'post_type' => 'product',
                        'post_status' => 'publish',
