    ...
    ?>
        <style>
            ...
            @media(min-width:768px){
                ...
                /* pie de página */
                    /* dirección */
                    .footer-widgets address li:is(:nth-child(4), :nth-child(n+6)){margin-left:2.4rem;}
                    /* copyright */
            ...
            @media(min-width:991px){
                ...
                /* frontpage */
                    ...
                    #main .container .best-selling.section .woocommerce .products .product:nth-child(1) .products-list__item .product-card__buttons .button.product_type_simple.add_to_cart_button.ajax_add_to_cart{height:3.8rem;font-size:1.7rem;display:flex;align-items:center;padding:0 2rem;}
