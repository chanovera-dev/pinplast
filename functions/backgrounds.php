...
function pinplast_theme_custom_backgrounds() {
    ?>
        <style>
            ...
            .slideshow-wrapper .slideshow .slide1.desktop{background:url('<?php echo get_theme_mod('slide_img1_desktop', get_bloginfo('template_url') . '/assets/img/slides/slide-1.jpg'); ?>');}
        </style>
    <?php
}
