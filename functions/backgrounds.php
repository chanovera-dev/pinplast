...
function pinplast_theme_custom_backgrounds() {
    ?>
        <style>
            ...
            .slideshow-wrapper .slideshow .slide.slide1.desktop{background-image:url('<?php echo get_theme_mod('slide_img1_desktop', get_bloginfo('template_url') . '/assets/img/slides/slide-1.jpg'); ?>'); background-repeat:no-repeat; background-position:50% 50%; background-size:cover;}
        </style>
    <?php
}
