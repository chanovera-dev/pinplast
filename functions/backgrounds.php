...
function pinplast_theme_custom_backgrounds() {
    ?>
        <style>
            ...
            #slideshow .slide1 {background:linear-gradient(to bottom, #0000005b, #00000000), url('<?php echo get_theme_mod('slide_img2_mobile', get_bloginfo('template_url') . '/assets/img/slides/slide-2-mobile-new.jpg'); ?>');}
            ...
            @media(min-width:1024px){
                ...
                #slideshow .slide1{background:linear-gradient(to right, #0000005b, #00000000), url('<?php echo get_theme_mod('slide_img2_desktop', get_bloginfo('template_url') . '/assets/img/slides/slide-2-new.jpg'); ?>');}
            ...
            @media(min-width:1200px){
                ...
                #slideshow .slide1{background:linear-gradient(to right, #0000005b, #00000000), url('<?php echo get_theme_mod('slide_img2_desktop_full', get_bloginfo('template_url') . '/assets/img/slides/slide-2-full-new.jpg'); ?>');}
